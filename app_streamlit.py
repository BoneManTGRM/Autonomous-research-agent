...
# Replace the misÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂencoded page icon with a valid emoji to prevent mojibake
# Use a valid Unicode emoji for the page icon instead of a doubleÃÂÃÂ¢ÃÂÃÂÃÂÃÂdecoded byte sequence
...
def compute_progress_view(
    ...
    # Only use phase progress when there is a multiÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂphase pipeline (phase_total > 1).
    ...
    # prevents singleÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂphase runs from displaying as "1 run" when multiple cycles are present.
    ...
    # conditions may result in fewer microÃÂÃÂ¢ÃÂÃÂÃÂÃÂcycles than the
    ...
    try:
        ...
        if isinstance(pd, dict):
            ...
            if mode_pd == "swarm":
                ...
                # microÃÂÃÂ¢ÃÂÃÂÃÂÃÂsteps down to a 1..max_rounds scale (e.g. 1/3ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2/3ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ3/3),
                # obscuring the true progress through all agents.  To better
                # reflect the swarmÃÂÃÂ¢ÃÂÃÂÃÂÃÂs workload, scale the macro total by the
        ...
        # Only remap internal step counts to a smaller macro cycle total for nonÃÂÃÂ¢ÃÂÃÂÃÂÃÂswarm runs.
        # In swarm mode we want to preserve the full microÃÂÃÂ¢ÃÂÃÂÃÂÃÂcycle progress (which may
        ...
        # progress bar reflects the full microÃÂÃÂ¢ÃÂÃÂÃÂÃÂcycle budget.  Do not adjust the
...
def _infer_agents_from_job_config(job_payload: Optional[Dict[str, Any]]) -> List[str]:
    ...
    # Prefer a topÃÂÃÂ¢ÃÂÃÂÃÂÃÂlevel roles list when present.  Some job creators
    ...
    # only when the topÃÂÃÂ¢ÃÂÃÂÃÂÃÂlevel list is absent.
...
def build_narrative_events_from_history(history: List[Dict[str, Any]], limit: int = LIVE_EVENTS_LIMIT) -> List[Dict[str, Any]]:
    ...
    for e in tail:
        ...
        if isinstance(d_r, (int, float)):
            ...
            parts.append(f"\u0394R {float(d_r):.3f}")  # ÃÂÃÂÃÂÃÂR
        if repairs_n:
...
<div class="ara-header">
    ...
    if False and use_biomarkers:
        ...
        biomarker_items = [
            ...
            ("Reactive Oxygen Metabolite (ROM)", "Reflects oxidative stress burden. High ROM accelerates DNA damage and cellular aging, while antioxidants such as vitaminÃÂÃÂÃÂÃÂ E can help reduce ROM and protect cells from oxidative damage."),
            ...
            ("DNA Damage (8ÃÂÃÂ¢ÃÂÃÂÃÂÃÂOHdG)", "Indicates oxidative damage to DNA. Elevated 8ÃÂÃÂ¢ÃÂÃÂÃÂÃÂOHdG suggests slowing DNA repair and accelerated aging; interventions with nutrients like zinc and vitaminÃÂÃÂÃÂÃÂ E may lower levels."),
            ("Intracellular NAD+", "NADÃÂÃÂ¢ÃÂÃÂÃÂÃÂº supports mitochondrial function and sirtuin activation but declines with age, contributing to fatigue and metabolic dysfunction. Testing cellular NADÃÂÃÂ¢ÃÂÃÂÃÂÃÂº helps identify opportunities for targeted supplementation."),
            ("VitaminÃÂÃÂÃÂÃÂ D", "Regulates immune and bone health. Deficiency increases risk for chronic disease and frailty; maintaining optimal levels supports immunity and strong bones."),
            ...
            ("Inflammation markers (hs-CRP, IL-1ÃÂÃÂÃÂÃÂ², IL-6, IL-8, TNF-ÃÂÃÂÃÂÃÂ±)", "Chronic low-grade inflammation (\"inflammaging\") damages tissues and increases risks for heart disease, diabetes and cognitive decline. Regular exercise, omega-3 fats and stress management can help control these markers."),
            ("Senescence-Associated ÃÂÃÂÃÂÃÂ²-Galactosidase (SABG or ÃÂÃÂÃÂÃÂ²-gal)", "Identifies senescent cells that accumulate with age. These ÃÂÃÂ¢ÃÂÃÂÃÂÃÂzombieÃÂÃÂ¢ÃÂÃÂÃÂÃÂ cells release inflammatory factors and contribute to chronic disease; emerging senolytic therapies aim to clear them."),
        ]
        ...
        if show_biomarker_citations:
            st.markdown("#### Sources and citations")
            citation_lines = [
                "Information on albuminÃÂÃÂ¢ÃÂÃÂÃÂÃÂs role and its association with chronic inflammation, malnutrition and frailty is summarised from JinfinitiÃÂÃÂ¢ÃÂÃÂÃÂÃÂs description of albumin and centenarian studiesÃÂÃÂ£ÃÂÃÂÃÂÃÂ203931968364787ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ L234-L246ÃÂÃÂ£ÃÂÃÂÃÂÃÂ.",
                "The functions of alkaline phosphatase (ALP) and alanine aminotransferase (ALT) and what elevated levels indicate are based on JinfinitiÃÂÃÂ¢ÃÂÃÂÃÂÃÂs discussion of these enzymesÃÂÃÂ£ÃÂÃÂÃÂÃÂ203931968364787ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ L248-L262ÃÂÃÂ£ÃÂÃÂÃÂÃÂ.",
                "The explanation of creatinineÃÂÃÂ¢ÃÂÃÂÃÂÃÂs role as a kidney function marker and how its levels change with age comes from JinfinitiÃÂÃÂ¢ÃÂÃÂÃÂÃÂs articleÃÂÃÂ£ÃÂÃÂÃÂÃÂ203931968364787ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ L264-L278ÃÂÃÂ£ÃÂÃÂÃÂÃÂ.",
                "Details about creatine kinase (CK) as a marker of muscle damage and its importance for mobility are drawn from JinfinitiÃÂÃÂ¢ÃÂÃÂÃÂÃÂs overviewÃÂÃÂ£ÃÂÃÂÃÂÃÂ203931968364787ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ L280-L290ÃÂÃÂ£ÃÂÃÂÃÂÃÂ.",
                "The description of reactive oxygen metabolites (ROM) and the protective effects of antioxidants like vitaminÃÂÃÂÃÂÃÂ E reflects JinfinitiÃÂÃÂ¢ÃÂÃÂÃÂÃÂs discussionÃÂÃÂ£ÃÂÃÂÃÂÃÂ203931968364787ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ L292-L303ÃÂÃÂ£ÃÂÃÂÃÂÃÂ.",
                "The summary of total antioxidant capacity (TAC) and its significance for disease risk is based on JinfinitiÃÂÃÂ¢ÃÂÃÂÃÂÃÂs explanationÃÂÃÂ£ÃÂÃÂÃÂÃÂ203931968364787ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ L305-L317ÃÂÃÂ£ÃÂÃÂÃÂÃÂ.",
                "Information on DNA damage (8ÃÂÃÂ¢ÃÂÃÂÃÂÃÂOHdG) as a marker of oxidative stress and how nutrition may reduce it comes from JinfinitiÃÂÃÂ£ÃÂÃÂÃÂÃÂ203931968364787ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ L320-L327ÃÂÃÂ£ÃÂÃÂÃÂÃÂ.",
                "The role of intracellular NADÃÂÃÂ¢ÃÂÃÂÃÂÃÂº in mitochondrial function, its decline with age and potential interventions are summarised from the Jinfiniti guideÃÂÃÂ£ÃÂÃÂÃÂÃÂ203931968364787ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ L329-L341ÃÂÃÂ£ÃÂÃÂÃÂÃÂ.",
                "Insights about vitaminÃÂÃÂÃÂÃÂ DÃÂÃÂ¢ÃÂÃÂÃÂÃÂs effect on immune function, bone health and frailty are drawn from JinfinitiÃÂÃÂ¢ÃÂÃÂÃÂÃÂs articleÃÂÃÂ£ÃÂÃÂÃÂÃÂ203931968364787ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ L342-L349ÃÂÃÂ£ÃÂÃÂÃÂÃÂ.",
                "The description of glycated serum protein (GSP) as a blood sugar indicator and its link to diabetes risk is based on JinfinitiÃÂÃÂ¢ÃÂÃÂÃÂÃÂs textÃÂÃÂ£ÃÂÃÂÃÂÃÂ203931968364787ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ L352-L359ÃÂÃÂ£ÃÂÃÂÃÂÃÂ.",
                "Information about blood lipids (HDL, LDL, triglycerides) and their relationship to cardiovascular health and longevity derives from the Jinfiniti discussionÃÂÃÂ£ÃÂÃÂÃÂÃÂ203931968364787ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ L364-L375ÃÂÃÂ£ÃÂÃÂÃÂÃÂ.",
                "The dual role of uric acid as both a risk factor and an antioxidant, and observations from centenarians, comes from JinfinitiÃÂÃÂ¢ÃÂÃÂÃÂÃÂs explanationÃÂÃÂ£ÃÂÃÂÃÂÃÂ203931968364787ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ L377-L389ÃÂÃÂ£ÃÂÃÂÃÂÃÂ.",
                "The significance of klotho as an anti-aging protein and its association with slower aging is summarised from JinfinitiÃÂÃÂ¢ÃÂÃÂÃÂÃÂs descriptionÃÂÃÂ£ÃÂÃÂÃÂÃÂ203931968364787ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ L392-L404ÃÂÃÂ£ÃÂÃÂÃÂÃÂ.",
                "The section on inflammation markers and the concept of inflammaging draws from JinfinitiÃÂÃÂ¢ÃÂÃÂÃÂÃÂs overviewÃÂÃÂ£ÃÂÃÂÃÂÃÂ203931968364787ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ L406-L419ÃÂÃÂ£ÃÂÃÂÃÂÃÂ.",
                "Information on senescence-associated ÃÂÃÂÃÂÃÂ²-galactosidase identifying senescent cells and the potential of senolytic therapies is taken from JinfinitiÃÂÃÂ¢ÃÂÃÂÃÂÃÂs articleÃÂÃÂ£ÃÂÃÂÃÂÃÂ203931968364787ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ L421-L430ÃÂÃÂ£ÃÂÃÂÃÂÃÂ.",
            ]
        ...
        if not goal_clean:
            ...
            if enable_swarm:
                swarm_config: Dict[str, Any] = {
                    ...
                    # Respect userÃÂÃÂ¢ÃÂÃÂÃÂÃÂrequested cycles in swarm mode.  Using 1 here
                    # would force a single miniÃÂÃÂ¢ÃÂÃÂÃÂÃÂcycle per agent regardless of
                    # the cycles slider.  Set to the requested cycles value.
                    "max_cycles_per_agent": int(cycles),
                    "stagger_start": False,
                    # Explicitly set the perÃÂÃÂ¢ÃÂÃÂÃÂÃÂtick agent cap to the swarm size so
                    # all agents can run each round.  Some backends interpret
                    # zero as a default limit (often 32), which would reduce
                    # a 64ÃÂÃÂ¢ÃÂÃÂÃÂÃÂagent swarm to 32 agents per tick.
                ...
                swarm_config = {
                    ...
                    "max_cycles_per_agent": int(cycles),
                    "stagger_start": False,
                    # For singleÃÂÃÂ¢ÃÂÃÂÃÂÃÂagent or non-swarm runs, allow one agent per tick.
            ...
            # rather than total microÃÂÃÂ¢ÃÂÃÂÃÂÃÂcycles.  Do not multiply by the swarm size
            # here; the worker will compute the effective microÃÂÃÂ¢ÃÂÃÂÃÂÃÂcycle count by
            ...
            # cycles * swarm_size microÃÂÃÂ¢ÃÂÃÂÃÂÃÂcycles but the swarm coordinator
